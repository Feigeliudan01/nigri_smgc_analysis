...
# option_list = list(
#   make_option(c("-s", "--setName"), action="store", default=NA, type='character',
#               help="Provide set name"),
#   make_option(c("-f", "--fileName"), action="store", default=NA, type='character',
#               help="Provide file name")
#   make_option(c("-t", "--treefile"), action="store", default=NA, type='character',
#               help="Provide file name")
# )
# opt = parse_args(OptionParser(option_list=option_list))

# filename = "sm_data_flavi_orgs_c.tsv"
# setname = "flavi_orgs"
# treeFile = "ingek_tree_JGIname.nwk"
...
filename = args[1]
treeFile = args[3]
# filename="sm_data_nigri_test_c.tsv"
# wd is already nigri_test
# treeFile="smBasicTree.nwk"
# Can only be executed after cluster families have been generated
# aspSetName = "flavi_orgs" #paste0(opt$s, "/") #"testSet/"
# filename = "smurfOrgIpr_clustered.tsv_Mibig.tsv"#smDataMibig.tsv
# getwd()
